...
#         SELECT Teachers.teacher_name, Classes.class_name
#         FROM Teachers
#         JOIN Teacher_Classes ON Teachers.teacher_id = Teacher_Classes.teacher_id
#         JOIN Classes ON Teacher_Classes.class_id = Classes.class_id
#     ''')
#     conn.close()
...
# def teacherclass(teacher_class_data):
#     teacher_class_data = teacherclass()
